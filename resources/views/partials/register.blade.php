  ...
  <div class="min-h-screen flex items-center justify-center">
   <div class="bg-gray-800 p-8 rounded-lg shadow-lg flex flex-col md:flex-row w-full max-w-4xl">
    ...
    <div class="md:w-1/2 mb-8 md:mb-0">
     ...
     <form class="mt-6 space-y-4" action="{{route('process-register')}}" method="POST">
        @csrf
      <input class="w-full p-3 bg-gray-700 rounded text-white focus:outline-none focus:ring-2 focus:ring-blue-500" name="name" placeholder="Name" type="text"/>
