...
<div class="container mt-5">
    <div class="flex justify-start mb-3">
        ...
        <h2 class="mb-4 text-2xl font-bold">Edit Data Pelanggan</h2>
        <form action="{{route('pelanggan.update', $pelanggan->id)}}" method="POST" class="space-y-4">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="NamaPelanggan" class="block w-full px-4 py-2 border-2 border-gray-300 rounded-md" id="Jenis_Kendaraan" value="{{$pelanggan->NamaPelanggan}}" placeholder="Masukkan Nama Pelanggan">
            </div>
            <div class="mb-3">
